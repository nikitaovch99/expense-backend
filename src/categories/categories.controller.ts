...
export class CategoriesController {
  ...
  @Post()
  create(@Body() dto: createCategoryDto, @Session() session: SessionParam) {
  ...
  @UseGuards(IsAuthenticatedGuard)
  @Get(':id')
  getById(@Param('id') id: string, @Session() session: SessionParam) {
    console.log('id', typeof id, { session });
  ...
  @UseGuards(IsAuthenticatedGuard)
  @Get()
  getAll(@Session() session: SessionParam) {
  ...
  @UseGuards(IsAuthenticatedGuard)
  @Delete(':id')
  remove(@Param('id') id: string, @Session() session: SessionParam) {
